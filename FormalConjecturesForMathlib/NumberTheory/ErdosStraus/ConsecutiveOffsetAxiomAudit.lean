...
import FormalConjecturesForMathlib.NumberTheory.ErdosStraus.ConsecutiveOffsets

/-!
# Consecutive-offset axiom audit

This standalone script reports the dependencies of the Type-I factor-pair and
consecutive-offset theorems.
-/
